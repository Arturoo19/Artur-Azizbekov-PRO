...
fun main() {
    val proceso = ProcessBuilder(
        ...
        "-javaagent:C:\\Program Files\\JetBrains\\IntelliJ IDEA Community Edition 2024.3.2.2\\lib\\idea_rt.jar=62147:C:\\Program Files\\JetBrains\\IntelliJ IDEA Community Edition 2024.3.2.2\\bin",
    ...
    val array = arrayOf("hola", "desde","el","proceso")
