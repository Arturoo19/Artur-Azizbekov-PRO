...
print("1️ Abriendo el fichero 'palabras.txt' en modo lectura...")
...
print("2️ Procesando el contenido...\n")
...
print("3️ Escribiendo los resultados en 'salida.txt' y 'salida2.txt'...\n")
